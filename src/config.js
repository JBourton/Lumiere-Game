...
export const SPAWN_INTERVAL = 1000; // [DEV NOTE]: I'll remove this later but for now it's best to test with freqeunt NPCs coming in
export const MAGIC_DECREASE_W_FRUSTR_RATE = 0.1;  // multiplier hyperparam for game tuning
export const MAGIC_DEC_INTERVAL = 5000; // hyperparam for how often the magic decrement penalty from congestion is applied
export const VISITOR_REDRAW_INTERVAL = 1000;